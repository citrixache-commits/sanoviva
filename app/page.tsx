    ...
    <header className={`sticky top-0 z-50 bg-white transition-shadow duration-300 ${scrolled ? "shadow-lg shadow-black/5" : "shadow-sm"}`}>
      ...
      <div className="site-container py-4 flex items-center justify-between gap-6">
        ...
        <a href="/" className="flex items-center gap-2.5 shrink-0 group">
          <div className="w-11 h-11 gradient-primary rounded-2xl flex items-center justify-center font-extrabold text-lg shadow-lg shadow-primary/20 group-hover:shadow-primary/40 transition-shadow ring-1 ring-[#FFB300]/50" style={{ color: '#FFB300' }}>
            S
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-6">
              <div className="w-10 h-10 gradient-primary rounded-2xl flex items-center justify-center font-extrabold text-lg shadow-lg shadow-primary/20 ring-1 ring-[#FFB300]/50" style={{ color: '#FFB300' }}>S</div>
